...
- [Go](https://opentelemetry.io/docs/instrumentation/go/getting-started/)
- [Java](https://opentelemetry.io/docs/instrumentation/java/automatic/) - Auto Instrumentation Support
- [JavaScript](https://opentelemetry.io/docs/instrumentation/js/instrumentation/) - Auto Instrumentation Support
- [PHP](https://opentelemetry.io/docs/instrumentation/php/getting_started/)
- [Python](https://opentelemetry.io/docs/instrumentation/python/getting-started/) - Auto Instrumentation Support
- [Ruby](https://opentelemetry.io/docs/instrumentation/ruby/automatic/) - Auto Instrumentation Support
